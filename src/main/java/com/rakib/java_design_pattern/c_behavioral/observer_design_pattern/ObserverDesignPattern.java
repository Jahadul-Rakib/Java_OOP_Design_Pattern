package com.rakib.java_design_pattern.c_behavioral.observer_design_pattern;

/*
 * Using this Design Pattern we can notify multiple objects when change state
 *
 * The observer pattern defines a one-to-many dependency between objects so that when one object changes state,
 * all of its dependents are notified and updated automatically. The object which is being watched is called the subject.
